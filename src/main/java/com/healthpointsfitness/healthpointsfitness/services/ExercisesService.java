...
public class ExercisesService {
    public List<Exercise> getExercisesByMuscle(Muscles muscle){
        try {
            AsyncHttpClient client = new DefaultAsyncHttpClient();
            Future<Response> request =  client.prepareGet("https://exercises-by-api-ninjas.p.rapidapi.com/v1/exercises?muscle=" + UriEncoder.encode(muscle.name()))
